//Program to retrieve certain numbers based on metric chosen
//minor practice with UI in java
...
public class Viewer
{
   ...
   public static void main(String[] args)
   {
	   Scanner in = new Scanner(System.in);
	      ...
	      quizes[0] = new Quiz("Joe", 60);
	      quizes[1] = new Quiz("Sally",90);
	      quizes[2] = new Quiz("Jane",100);
	      quizes[3] = new Quiz("Billy",85);
