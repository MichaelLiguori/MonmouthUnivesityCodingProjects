//A sample project simulating a cash register with the ability to enter amounts and recieve the total based on discount applied 
//Also provides change back when amount given is over balance due
